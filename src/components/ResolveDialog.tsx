...
export function ResolveDialog({ open, onClose, onResolve, complaintTitle }: ResolveDialogProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // TODO: Enable when supabase/client is created
      ...
      const placeholderUrl = `https://placeholder.com/image_${timestamp}.jpg`;

      console.log('Image would upload to:', fileName);
      toast.success('Image upload placeholder - Supabase not configured yet');

      // Pass the public URL to parent component
      onResolve(placeholderUrl);
